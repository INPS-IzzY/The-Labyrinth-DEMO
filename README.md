**The Labyrinth**
You are Theseus on his journey through the Labyrinth at the behest of the beautiful Ariadne to slay her brother, The Minotaur, who is the only one keeping the Labryinth together.

# Development Game Outline (3/12/26)

Theseus
- 

## Levels
DEMO: 3 Levels, 3 Sections each, 6 rooms per section

Each mythology has its own level, though there is some overlap

## God Rooms
### Zeus
Normal room: background is blue sky
Corners of room are oak trees with clouds for leaves
Center of room has a pedastal engraved with "ZEUS" with a lightning bolt and an eagle on top of the bolt
- You can hit Interact to "Interact with Pedastal": this summons a spectral version of Zeus. After the player completes this dialogue, they can accept the quest or "decline" the quest. If you decline the quest, Zeus gives you the quest anyways, but if you fail you get larger debuffs.

**Zeus' Quest:**

### Dionysus

**Dionysus' Quest:** Set him up with Ariadne


## Special Rooms
### Aquarium
Narcissus' Lake
**Quest:** Give Narcissus something to help him ... mirror ... Echo.

### Free the Hostages
- Beat all the monsters to get a gold

### Treasure Rooms
- Beat all the monsters to get a good weapon, armor, etc

### Teaser Rooms
- Rooms where other mythologies blend in
...
## Room (hand-made but are ordered randomly)
Rooms have 1-3 exits
Randomly generated exits to randomly selected rooms 
The game determines a random tree of rooms such that no room is repeated twice within its branch.


The boss room has only one exit -> next level
The checkpoint room only have one exit -> boss room
The fifth room only has one exit -> checkpoint


Final Room of a Section has a Boss
Final Room of the Final Section has the Final Boss (Minotaur)


Side-on player view like Hollow Knight


Each room has monsters
- What do monsters drop?



# - Nudges to talk to Ariadne!!!
...
If you can't get through the challenge, you cannot exit any other way and will have to restart
If you can get through the challenge, you go to back to where you were when you died but with nothing that you weren't wearing


Repository created Thursday, March 5th, 2026